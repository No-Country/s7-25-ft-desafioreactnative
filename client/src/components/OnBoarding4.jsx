        ...
        <SafeAreaView style={styles.container}>
          <TailImage style={{backgroundColor:'#22242A'}} source={require('../../assets/ImgOnBoarding/OnBoarding4.png')} className='w-full h-full justify-end items-center'>
            <TailSafeAreaView className='w-3/4 h-2/4 flex-col justify-center items-center'>
              <TailText style={{ fontFamily: 'Roboto-Bold', fontSize:height*0.035 }} className='text-neutralLightGray antialiased text-center'>VENDÉ</TailText>
              <TailText style={{ fontFamily: 'Montserrat-Bold',fontSize:height*0.018,marginTop:height*0.04,marginBottom:height*0.06,lineHeight:height*0.028 }} className='text-neutralLightGray text-center'>OFRECÉ TUS TRABAJO A CLIENTES{'\n'}QUE LO NECESITAN</TailText>
